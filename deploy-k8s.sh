...
echo "   3. Setup Vault: ./scripts/setup-vault.sh"
echo "   4. Setup APISIX: ./scripts/setup-apisix.sh"
echo "   5. Access APISIX Dashboard: http://localhost:30910 (admin/admin)"
echo "   6. Run your application: mvnd quarkus:dev"
